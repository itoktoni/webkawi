...
<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has($template.'_visible') ? 'has-error' : ''}}">
        {{ Form::select($template.'_visible', ['1' => 'Yes', '0' => 'No'], null, ['class'=> 'form-control', 'data-plugin-selectTwo','data-plugin-options' => '{"placeholder": "Select a State", "allowClear": true,"tags":true }']) }}
