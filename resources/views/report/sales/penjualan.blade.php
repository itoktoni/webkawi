                ...
                <div class="form-group">
                   ...
                   <div class="col-md-4 {{ $errors->has('customer_id') ? 'has-error' : ''}}">
                    <select class="form-control col-md-4 option" name="customer">
                        ...
                        <option @isset($data) {{ $value->customer_id == $data->customer_name ? 'selected="selected"' : '' }} @endisset value="{{ $value->customer_id }}">{{ $value->customer_name }}
                        </option>
                        @endif
                        @else
                 ...
                 <div class="form-group">
                   ...
                   <div class="col-md-4 {{ $errors->has('site_id') ? 'has-error' : ''}}">
                    <select class="form-control col-md-4 option2" name="site">
                        <option value="">Select Site</option>
                        @foreach($site as $value)
                        <option @isset($data) {{ $value->site_id == $data->site_name ? 'selected="selected"' : '' }} @endisset value="{{ $value->site_id }}">{{ $value->site_name }}</option>
                        @endforeach
                    </select>
                    </div>
                </div>
