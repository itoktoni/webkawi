        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <h2 id="total" class="panel-title text-left">
                    <span id="total_name">Total : </span> <span class="money" id="total_value">{{ number_format($model->detail->sum('purchase_detail_total_order')) }}</span>
                    <input type="hidden" id="hidden_total" value="{{ $model->detail->sum('purchase_detail_total_order') }}" name="total">
                </h2>
                @else
                <h2 id="total" class="panel-title text-left">
