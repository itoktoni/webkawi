...
class VendorDetailRepository extends VendorRepository implements MasterInterface
{
    public $data;
    public $mapping  = [
        'primary' => 'procurement_vendor_product_vendor_id',
        'foreign' => 'procurement_vendor_product_product_id',
        'detail' => [
            'procurement_vendor_product_product_id' => 'temp_id',
            'procurement_vendor_product_price' => 'temp_price',
            'procurement_vendor_product_min' => 'temp_min',
            'procurement_vendor_product_max' => 'temp_max',
        ]
    ];
