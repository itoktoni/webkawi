<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has($form.'product_id') ? 'has-error' : ''}}">
        {{ Form::select($form.'product_id', $product, null, ['class'=> 'form-control', 'data-plugin-selectTwo']) }}
        {!! $errors->first($form.'product_id', '<p class="help-block">:message</p>') !!}
    </div>
