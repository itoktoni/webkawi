...
<body>
    ...
    <img style="background-color:white;position:absolute;top:46px;left:3px;height:133px;border:0.1px solid #d4d4d4;padding:10px;"
                ...
                <td bgcolor="#ffffff" id="m_-3784408755349078820contentContainer"
                    ...
                    <div>
                        <table id="border" border="0" cellpadding="5" cellspacing="0"
                            id="m_-3784408755349078820templateList" width="82%"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th colspan="3"
                                        ...
                                        <h2
                                            ...
                                            No. Order : {{ str_replace('SO', 'DO', $master->sales_order_id) }}
                                        </h2>
                                    </th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="left" valign="middle" width="50%"
                                        style="border-collapse:collapse;border-spacing:0;font-family:Arial,sans-serif;color:#555;line-height:1.5;border-bottom-color:#cccccc;border-bottom-width:1px;border-bottom-style:solid;margin:0;padding:5px 10px"
                                        bgcolor="#FFFFFF">
                                        {{ $item->product->item_product_name }} {{ $item->sales_order_size }} {{ $item->color->item_color_name }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <th colspan="3"
                                        ...
                                        <h5
                                            ...
                                            {{ number_format($detail->sum->sales_order_detail_qty_prepare,0,",",".") }}
                                        </h5>
                                    </th>
                                </tr>
